...
func encode(src, lut []byte) (dst []byte) {
	...
	VL_UINT64([]uint64{0x0fc0fc000fc0fc00, 0x0fc0fc000fc0fc00}, MULHI_MASK)
	VL_UINT64([]uint64{0x0400004004000040, 0x0400004004000040}, MULHI_CONST)
	VN(X0, MULHI_MASK, X1)
	VMLHH(X1, MULHI_CONST, X1)
	VL_UINT64([]uint64{0x003F03F0003F03F0, 0x003F03F0003F03F0}, MULLO_MASK)
	VL_UINT64([]uint64{0x0100001001000010, 0x0100001001000010}, MULLO_CONST)
	VN(X0, MULLO_MASK, X2)
	VMLHW(X2, MULLO_CONST, X2)
	VO(X1, X2, X0)

	VZERO(ZERO)
	VL_UINT64([]uint64{0x3333333333333333, 0x3333333333333333}, RANGE1_END)
	VSB(RANGE1_END, X0, X1)
	VMXB(ZERO, X1, X1)

	VL_UINT64([]uint64{0x1919191919191919, 0x1919191919191919}, RANGE0_END)
...
func decodeSTD(src []byte) (dst []byte, err error) {
	...
	VL_UINT64([]uint64{0x4001400140014001, 0x4001400140014001}, dec_reshuffle_const0)
	VL_UINT64([]uint64{0x1000000110000001, 0x1000000110000001}, dec_reshuffle_const1)
